...
import 'package:bookshelf_api/src/api_module.dart' as _i3;
...
import 'src/app/app_module.dart' as _i5;
import 'src/login/auth_gate.dart' as _i6;
import 'src/login/login_page.dart' as _i12;
import 'src/login/login_view_model.dart' as _i14;
import 'src/session/book_repository.dart' as _i8;
import 'src/session/home_page.dart' as _i9;
import 'src/session/session_component.dart' as _i7;
...
class MainComponent$Component implements _i1.MainComponent {
  ...
  MainComponent$Component._(
    _i2.CoreModule coreModule,
    _i3.ApiModule apiModule,
    _i4.AuthModule authModule,
    _i5.AppModule appModule,
  ) {
    _logger$Provider = _Logger$Provider(coreModule);
    _booksApi$Provider = _BooksApi$Provider(_logger$Provider, apiModule);
    ...
    final sessionComponentFactory$Provider = _SessionComponentFactory$Provider(
      this,
    );
    _authGateFactory$Provider = _AuthGateFactory$Provider(
      loginPageFactory$Provider,
      sessionComponentFactory$Provider,
    );
  }
  ...
  @override
  _i6.AuthGateFactory get authGateFactory => _authGateFactory$Provider.get();
}

class SessionComponent$Subcomponent implements _i7.SessionComponent {
  factory SessionComponent$Subcomponent.create(
    MainComponent$Component parent, {
    _i7.SessionModule? sessionModule,
    required _i2.Credentials credentials,
  }) => SessionComponent$Subcomponent._(
    parent,
    sessionModule ?? _i7.SessionModule(),
    credentials,
  );
...
class _SessionComponentFactory$Factory implements _i7.SessionComponentFactory {
  const _SessionComponentFactory$Factory(this._parent);

  final MainComponent$Component _parent;

  @override
  _i7.SessionComponent create(_i2.Credentials credentials) =>
      SessionComponent$Subcomponent.create(_parent, credentials: credentials);
}

class _AuthGateFactory$Factory implements _i6.AuthGateFactory {
  ...
  @override
  _i6.AuthGate create({_i10.Key? key}) => _i6.AuthGate(
    key: key,
...
class _AuthGateFactory$Provider implements _i11.Provider<_i6.AuthGateFactory> {
  ...
  late final _i6.AuthGateFactory _factory = _AuthGateFactory$Factory(
    _loginPageFactory$Provider,
    _sessionComponentFactory$Provider,
  );

  @override
  _i6.AuthGateFactory get() => _factory;
}
...
class _BooksApi$Provider implements _i11.Provider<_i3.BooksApi> {
  _BooksApi$Provider(this._logger$Provider, this._module);

  final _Logger$Provider _logger$Provider;

  final _i3.ApiModule _module;

  late final _i3.BooksApi _singleton = _create();

  _i3.BooksApi _create() => _module.provideApi(_logger$Provider.get());

  @override
  _i3.BooksApi get() => _singleton;
}
...
class _LoginPageFactory$Factory implements _i12.LoginPageFactory {
  ...
  @override
  _i12.LoginPage create({
    _i10.Key? key,
    required _i13.ValueChanged<_i2.Credentials> onLoggedIn,
  }) => _i12.LoginPage(
    key: key,
...
class _LoginPageFactory$Provider
    implements _i11.Provider<_i12.LoginPageFactory> {
  _LoginPageFactory$Provider(this._viewModelFactoryOfLoginViewModel$Provider);

  final _ViewModelFactoryOfLoginViewModel$Provider
  _viewModelFactoryOfLoginViewModel$Provider;

  late final _i12.LoginPageFactory _factory = _LoginPageFactory$Factory(
    _viewModelFactoryOfLoginViewModel$Provider,
  );

  @override
  _i12.LoginPageFactory get() => _factory;
}

class _LoginViewModel$Provider implements _i11.Provider<_i14.LoginViewModel> {
  const _LoginViewModel$Provider(this._authRepository$Provider);

  final _AuthRepository$Provider _authRepository$Provider;

  @override
  _i14.LoginViewModel get() =>
      _i14.LoginViewModel(authRepository: _authRepository$Provider.get());
}
...
class _SessionComponent$BookRepository$Provider
  ...
  final _i7.SessionModule _module;
...
class _SessionComponent$HomePageFactory$Factory implements _i9.HomePageFactory {
  ...
  @override
  _i9.HomePage create({_i10.Key? key, required _i15.VoidCallback onLogout}) =>
      _i9.HomePage(
        key: key,
        viewModelFactory:
...
class _SessionComponent$ViewModelFactoryOfBooksViewModel$Provider
    implements _i11.Provider<_i16.ViewModelFactory<_i9.BooksViewModel>> {
  ...
  @override
  _i16.ViewModelFactory<_i9.BooksViewModel> get() =>
      ({
        required _i16.ViewModelWidgetBuilder<_i9.BooksViewModel> builder,
        _i17.Widget? child,
        _i16.ViewModelErrorBuilder? error,
        _i16.ViewModelInitializer<_i9.BooksViewModel>? init,
        _i10.Key? key,
        _i17.Widget? loading,
      }) => _i16.ViewModelBuilder<_i9.BooksViewModel>(
        key: key,
...
class _SessionComponentFactory$Provider
    implements _i11.Provider<_i7.SessionComponentFactory> {
  _SessionComponentFactory$Provider(this._parent);

  final MainComponent$Component _parent;

  late final _i7.SessionComponentFactory _factory =
      _SessionComponentFactory$Factory(_parent);

  @override
  _i7.SessionComponentFactory get() => _factory;
}

class _ViewModelFactoryOfLoginViewModel$Provider
    implements _i11.Provider<_i16.ViewModelFactory<_i14.LoginViewModel>> {
  ...
  @override
  _i16.ViewModelFactory<_i14.LoginViewModel> get() =>
      ({
        required _i16.ViewModelWidgetBuilder<_i14.LoginViewModel> builder,
        _i17.Widget? child,
        _i16.ViewModelErrorBuilder? error,
        _i16.ViewModelInitializer<_i14.LoginViewModel>? init,
        _i10.Key? key,
        _i17.Widget? loading,
      }) => _i16.ViewModelBuilder<_i14.LoginViewModel>(
        key: key,
