...
import 'qualified_entry_point_component.dart' as _i1;
...
class MyComponent$Component implements _i1.MyComponent {
  ...
  MyComponent$Component._(_i1.CoffeeModule coffeeModule) {
    ...
    _stringBrandName$Provider = _StringBrandName$Provider(coffeeModule);
  }
  ...
  @override
  String get brand => _stringBrandName$Provider.get();
}
...
class _StringBrandName$Provider implements _i2.Provider<String> {
