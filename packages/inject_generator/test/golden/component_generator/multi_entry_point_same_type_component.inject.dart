...
import 'multi_entry_point_same_type_component.dart' as _i1;
...
class MyComponent$Component implements _i1.MyComponent {
  ...
  @override
  _i1.CoffeeMaker get regularCoffee => _coffeeMaker$Provider.get();

  @override
  _i1.CoffeeMaker get decafCoffee => _coffeeMaker$Provider.get();
}
...
class _CoffeeMaker$Provider implements _i2.Provider<_i1.CoffeeMaker> {
  ...
  @override
  _i1.CoffeeMaker get() => _module.coffee();
}
