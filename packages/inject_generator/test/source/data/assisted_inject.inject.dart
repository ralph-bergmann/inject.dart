...
class Component$Component implements _i1.Component {
  ...
  Component$Component._() {
    ...
    _annotatedClassFactory$Provider = _AnnotatedClassFactory$Provider(foo$Provider);
    _annotatedConstructorFactory$Provider = _AnnotatedConstructorFactory$Provider(foo$Provider);
  }

  late final _AnnotatedClassFactory$Provider _annotatedClassFactory$Provider;

  late final _AnnotatedConstructorFactory$Provider _annotatedConstructorFactory$Provider;

  @override
  _i1.AnnotatedClassFactory get annotatedClassFactory => _annotatedClassFactory$Provider.get();
...
class _AnnotatedClassFactory$Provider implements _i2.Provider<_i1.AnnotatedClassFactory> {
  _AnnotatedClassFactory$Provider(this._foo$Provider);

  final _Foo$Provider _foo$Provider;

  late final _i1.AnnotatedClassFactory _factory = _AnnotatedClassFactory$Factory(_foo$Provider);
...
class _AnnotatedClassFactory$Factory implements _i1.AnnotatedClassFactory {
  ...
  @override
  _i1.AnnotatedClass create({required _i1.Bar bar}) =>
      _i1.AnnotatedClass(_foo$Provider.get(), bar: bar);
}
...
class _AnnotatedConstructorFactory$Provider
  ...
  late final _i1.AnnotatedConstructorFactory _factory = _AnnotatedConstructorFactory$Factory(
    _foo$Provider,
  );
...
class _AnnotatedConstructorFactory$Factory implements _i1.AnnotatedConstructorFactory {
  ...
  _i1.AnnotatedConstructor create({required _i1.Bar bar}) =>
      _i1.AnnotatedConstructor(_foo$Provider.get(), bar: bar);
}
